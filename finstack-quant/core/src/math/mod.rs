...
pub use linalg::{
    apply_lower_triangular, cholesky_correlation, cholesky_decomposition, symmetric_eigen,
    validate_correlation_matrix, validate_correlation_matrix_detailed, CholeskyError,
    CorrelationError, CorrelationFactor,
};
