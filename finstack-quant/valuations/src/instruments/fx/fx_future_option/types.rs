//! General-purpose FX futures-option instrument.
...
#[builder(validate = FxFutureOption::validate)]
#[serde(deny_unknown_fields)]
pub struct FxFutureOption {
...
impl FxFutureOption {
    /// Construct an FX futures option from arbitrary caller-supplied terms.
    ///
    /// # Arguments
    ///
    ...
    pub fn example() -> finstack_quant_core::Result<Self> {
        Self::new(
            InstrumentId::new("FX-FUTURE-OPTION-EXAMPLE"),
...
crate::instruments::common_impl::listed::impl_future_option_instrument!(
    FxFutureOption,
    crate::pricer::InstrumentType::FxFutureOption
);
