...
//! - See [`models::closed_form::asian`](finstack_quant_models::closed_form::asian) for formulas
//!
//! # References
//!
...
//! - [`models::closed_form::asian`](finstack_quant_models::closed_form::asian) for pricing formulas
