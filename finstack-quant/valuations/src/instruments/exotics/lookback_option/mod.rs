...
//! - See [`models::closed_form::lookback`](finstack_quant_models::closed_form::lookback)
//!
//! # References
//!
...
//! - [`models::closed_form::lookback`](finstack_quant_models::closed_form::lookback) for formulas
