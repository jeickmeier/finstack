...
use crate::calibration::step_runtime::StepOutcome;
...
fn aggregate_plan_report(
    ...
    report.update_metadata(
        ...
        match config.market_freshness.quote_side {
            crate::calibration::config::MarketQuoteSide::Mid => "mid",
            crate::calibration::config::MarketQuoteSide::Bid => "bid",
            crate::calibration::config::MarketQuoteSide::Ask => "ask",
        },
    );
    report.update_metadata(
        "bid_ask_validation",
