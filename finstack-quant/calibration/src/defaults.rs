...
pub const CALIBRATION_DEFAULTS_EXTENSION_KEY: &str = "calibration.defaults.v1";

const CALIBRATION_DEFAULTS: &str = include_str!("../data/calibration/calibration_defaults.v1.json");
