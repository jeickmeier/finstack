...
use crate::factor::{FactorCovarianceMatrix, FactorId};
...
mod tests {
    ...
    use crate::factor::matching::CREDIT_GENERIC_FACTOR_ID;
    ...
    fn calibrate_sample_full(
        ...
        let config = CreditCalibrationConfig {
            ...
            beta_shrinkage: crate::factor::credit::calibration::BetaShrinkage::None,
