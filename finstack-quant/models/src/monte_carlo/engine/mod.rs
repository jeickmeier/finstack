...
//! [`McEngine`] combines a [`crate::monte_carlo::traits::RandomStream`], a
//! [`crate::monte_carlo::traits::StochasticProcess`], a compatible
//! [`crate::monte_carlo::traits::Discretization`], and a [`crate::monte_carlo::traits::Payoff`] into
