//! Scaling guards for `finstack-quant-factor-model`.
//!
...
use finstack_quant_factor_model::credit::calibration::{CovarianceStrategy, CreditCalibrator};
use finstack_quant_factor_model::credit::decomposition::decompose_levels;
use finstack_quant_factor_model::credit::histories::historical_factor_pnl;
use finstack_quant_factor_model::matching::{
    CreditHierarchicalMatcher, FactorMatcher, MappingTableMatcher,
};
use finstack_quant_factor_model::{CurveType, FactorCovarianceMatrix, MarketDependency};
use fixtures::{
