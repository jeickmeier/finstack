 ...
 *
 */
export type MarketQuote = { "class": "rates" } & RateQuote | { "class": "cds" } & CdsQuote | { "class": "cds_tranche" } & CdsTrancheQuote | { "class": "inflation" } & InflationQuote | { "class": "vol" } & VolQuote | { "class": "xccy" } & XccyQuote;
