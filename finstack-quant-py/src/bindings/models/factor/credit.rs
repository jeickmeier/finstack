...
impl PyCreditFactorModel {
    pub(crate) fn from_inner(
        inner: finstack_quant_models::factor::credit::hierarchy::CreditFactorModel,
    ) -> Self {
        Self { inner }
    }
}
...
pub struct PyFactorCovarianceMatrix {
    pub(crate) inner: finstack_quant_models::factor::FactorCovarianceMatrix,
}

impl PyFactorCovarianceMatrix {
    fn from_inner(inner: finstack_quant_models::factor::FactorCovarianceMatrix) -> Self {
        Self { inner }
    }
}
...
impl PyFactorCovarianceMatrix {
    ...
    fn variance(&self, factor_id: &str) -> f64 {
        self.inner
            .variance(&finstack_quant_models::factor::FactorId::new(factor_id))
    }
    ...
    fn covariance(&self, lhs: &str, rhs: &str) -> f64 {
        self.inner.covariance(
            &finstack_quant_models::factor::FactorId::new(lhs),
            &finstack_quant_models::factor::FactorId::new(rhs),
        )
    }
...
pub struct PyFactorModelConfig {
    pub(crate) inner: finstack_quant_models::factor::FactorModelConfig,
}

impl PyFactorModelConfig {
    fn from_inner(inner: finstack_quant_models::factor::FactorModelConfig) -> Self {
        Self { inner }
    }
}
...
impl PyFactorModelConfig {
    ...
    #[staticmethod]
    fn from_json(json: &str) -> PyResult<Self> {
        let inner: finstack_quant_models::factor::FactorModelConfig =
            serde_json::from_str(json).map_err(display_to_py)?;
